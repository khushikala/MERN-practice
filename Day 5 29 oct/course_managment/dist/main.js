...
// 1️⃣ Add instructors
const khushi = instructorManager.addInstructor("khushi kala", [
...
// 2️⃣ Add students
const nannu = studentManager.addStudent("nannu");
const yash = studentManager.addStudent("yash");
console.log("\nStudents:", studentManager.getAllStudents());
// 3️⃣ Create courses
const jsCourse = courseManager.createCourse("JavaScript for Beginners", CourseCategory.DEVELOPMENT, khushi.id, "Learn the fundamentals of JavaScript.");
...
// 4️⃣ Enroll students
courseManager.enrollStudent(jsCourse.id, nannu.id);
courseManager.enrollStudent(jsCourse.id, yash.id);
courseManager.enrollStudent(uiCourse.id, nannu.id);
...
studentManager.removeStudent(nannu.id);
