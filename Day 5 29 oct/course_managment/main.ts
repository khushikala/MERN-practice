...
// 2️⃣ Add students
const shanu = studentManager.addStudent("shanu");
...
// 4️⃣ Enroll students
courseManager.enrollStudent(jsCourse.id, shanu.id);
courseManager.enrollStudent(jsCourse.id, yash.id);
courseManager.enrollStudent(uiCourse.id, shanu.id);
...
studentManager.removeStudent(shanu.id);
